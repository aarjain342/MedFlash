...
Write exactly 10 multiple-choice questions on this topic: TWO questions at each difficulty level 1 through 5 (1 = a straightforward recall/definition question, 5 = a hard, multi-step clinical vignette requiring integration of several concepts — the kind that trips up strong students). The two questions at the same level must test genuinely different angles of the material (different fact, different scenario, different distractor set) — never near-duplicates of each other. Each question must be answerable using only the material above; don't test facts that aren't covered by these flashcards.
